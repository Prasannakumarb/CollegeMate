...
public class Masterusertable {
    ...
    public Masterusertable( String collid, String colname,String courid,String courname,String deptid,String deptname){
        Masterusertable._courseid = collid;
        Masterusertable._college_name = colname;
        Masterusertable._courseid = courid;
        Masterusertable._coursename = courname;
        Masterusertable._department_id = deptid;
        Masterusertable._departmentname = deptname;
    }
